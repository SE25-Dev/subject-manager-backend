 ...
 */
management_router.put("/:courseId/details", verifyTokenAndExtractUser, checkRole(['headteacher']), async (req, res) => {
 ...
 */
management_router.put("/:courseId/password", verifyTokenAndExtractUser, checkRole(['headteacher']), async (req, res) => {
    const courseId = req.params.courseId;
